...
do
    ...
    java -jar transformation/rmlmapper.jar -m transformation/maps/XML2RDF.rml.ttl -f transformation/functions/functions.ttl transformation/functions/functions_grel.ttl transformation/functions/grel_java_mapping.ttl -s turtle -o $file.ttl
    git checkout transformation/maps/XML2RDF.rml.ttl
    echo >> ./../data/output.ttl
